...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= site_url('beranda/p/beranda') ?>" style="text-transform: uppercase;">Neo Laundry</a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?= base_url('assets/images/user1.png') ?>" width="60" height="60" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Welcome <?= $this->session->userdata['user'] ?>!</div>
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?= site_url('beranda/p/about') ?>"><i class="material-icons">person</i>About</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?= $master; ?> >
                        ...
                        <ul class="ml-menu">
                            <li><a href="<?= site_url('kasir/p/data')  ?>">Data Kasir</a></li>
                            <li><a href="<?= site_url('konsumen/p/data')  ?>">Data Konsumen</a></li>
                            <li><a href="<?= site_url('paket/p/data')  ?>">Data Paket</a></li>
                            <li><a href="<?= site_url('transaksi/p/data')  ?>">Data Transaksi</a></li>
                        </ul>
                    </li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2021 <a href="javascript:void(0);">Neo Laundry</a>.
                </div>
            </div>
            <!-- #Footer -->
        </aside>
