                ...
                <?= form_open_multipart($url); ?>
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="keterangan" id="keterangan" value="<?= $val['keterangan']; ?>" class="form-control" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="date" name="tgl_ambil" id="tgl_ambil" value="<?= $val['tgl_ambil']; ?>" class="form-control" placeholder="Y/M/D">
                                </div>
                            </div>
                    </div>
